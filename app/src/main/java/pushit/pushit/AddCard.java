...
//        Glide.with(AddCard.this).load(user_image).error(R.drawable.camera).into(image);
        Glide.with(this).load(user_image).bitmapTransform(new CropCircleTransformation(new CustomBitmapPool())).override(300, 200).into(image);
